...
class Masscan(object):
    ...
    def check_ip_format(self, ip_address):
        """
        Check if input IP Address is in CIDR format. Request user to input valid format and set the 'target' attribute.
        :return: true if correct format, false if invalid format
        """
